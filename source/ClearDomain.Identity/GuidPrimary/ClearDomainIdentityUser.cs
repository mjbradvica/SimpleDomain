...
{
    /// <summary>
    /// Base class for a <see cref="IdentityUser{TKey}"/> with ClearDomain functionality.
    /// </summary>
    public abstract class ClearDomainIdentityUser : IdentityUser<Guid>, IAggregateRoot, IEquatable<ClearDomainIdentityUser>
    {
